<?php
	...
	if(empty($in_Account_Number) || empty($in_Account_Name) || empty($in_Class) ||
		...
		$Sql_Query = "INSERT INTO pre_reg (Bil_Account_Number, Bil_Account_Name, Bil_Address, Bil_Class, 
								Stub_Number, Signature, Photo_ID, Contact_Number, Date_Registered) VALUES ('$in_Account_Number',
								'$in_Account_Name', '$in_Address', '$in_Class', '$rand_Stub_Number', 
		...
		mysqli_set_charset($con,'utf8');
		$Sql_Query_Copy = "INSERT INTO overall_reg (Bil_Account_Number, Bil_Account_Name, Bil_Address, Bil_Class, 
						Stub_Number, Town, Signature, Username_Reg, Contact_Number, Date_Registered) VALUES ('$in_Account_Number',
						'$in_Account_Name', '$in_Address', '$in_Class', '$rand_Stub_Number', 
						'$in_Town', ? , '$in_Username', '$in_Contact_Number', '$date')";
